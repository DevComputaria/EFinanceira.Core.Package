...
namespace ExemploCriptografiaLoteEFinanceira
{
    public class Program
    {
        ...
        {            
            if (args.Length < 2)
            {
                Console.WriteLine("Criptografa um arquivo de lote da e-Financeira");
                Console.WriteLine(string.Empty);
                Console.WriteLine("ExemploCriptografiaLoteEFinanceira.exe [path_arquivo_lote_a_ser_criptografado] [thumbprint_certificado]");
                return;
            }
