...
using EFinanceira.Messages.Generated.Eventos.EvtFechamentoeFinanceiraAlt;

namespace EFinanceira.Messages.Builders.Eventos.EvtFechamentoeFinanceiraAlt;

/// <summary>
/// Mensagem de evento de Fechamento e-Financeira Alternativo
/// </summary>
public sealed class EvtFechamentoeFinanceiraAltMessage : IEFinanceiraMessage
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="EvtFechamentoeFinanceiraAltMessage"/> class.
    /// Construtor sem parâmetros necessário para serialização XML.
    /// </summary>
    public EvtFechamentoeFinanceiraAltMessage()
    {
        Version = "v1_2_2_alt";
    ...
    internal EvtFechamentoeFinanceiraAltMessage(eFinanceiraEvtFechamentoeFinanceira evento, string version)
    {
        Evento = evento;
        Version = version;
        IdValue = evento.id;
...
/// <summary>
/// Builder principal para construção de eventos de Fechamento e-Financeira Alternativo.
/// Utiliza o padrão fluent interface para facilitar a criação de eventos estruturados.
/// </summary>
public sealed class EvtFechamentoeFinanceiraAltBuilder : IMessageBuilder<EvtFechamentoeFinanceiraAltMessage>
{
    private readonly eFinanceiraEvtFechamentoeFinanceira _evento;
    private readonly string _version;

    /// <summary>
    /// Initializes a new instance of the <see cref="EvtFechamentoeFinanceiraAltBuilder"/> class.
    /// </summary>
    /// <param name="version">Versão do schema (padrão: v1_2_2_alt)</param>
    public EvtFechamentoeFinanceiraAltBuilder(string version = "v1_2_2_alt")
    {
        _version = version;
    ...
    /// <summary>
    /// Cria uma nova instância do builder EvtFechamentoeFinanceiraAlt
    /// </summary>
    /// <param name="version">Versão do schema</param>
    /// <returns>Nova instância do builder</returns>
    public static EvtFechamentoeFinanceiraAltBuilder Create(string version = "v1_2_2_alt") => new(version);
    ...
    public EvtFechamentoeFinanceiraAltBuilder WithId(string id)
    {
        _evento.id = id;
        return this;
    }
    ...
    /// <returns>Instância atual do builder para encadeamento</returns>
    public EvtFechamentoeFinanceiraAltBuilder WithIdeEvento(Action<IdeEventoBuilder> configAction)
    {
    ...
    /// <returns>Instância atual do builder para encadeamento</returns>
    public EvtFechamentoeFinanceiraAltBuilder WithIdeDeclarante(Action<IdeDeclaranteBuilder> configAction)
    {
    ...
    /// <returns>Instância atual do builder para encadeamento</returns>
    public EvtFechamentoeFinanceiraAltBuilder WithInfoFechamento(Action<InfoFechamentoBuilder> configAction)
    {
    ...
    /// <returns>Instância atual do builder para encadeamento</returns>
    public EvtFechamentoeFinanceiraAltBuilder WithFechamentoPP(Action<FechamentoPPBuilder> configAction)
    {
    ...
    /// <returns>Instância atual do builder para encadeamento</returns>
    public EvtFechamentoeFinanceiraAltBuilder WithFechamentoMovOpFin(Action<FechamentoMovOpFinBuilder> configAction)
    {
    ...
    /// <returns>Instância atual do builder para encadeamento</returns>
    public EvtFechamentoeFinanceiraAltBuilder WithFechamentoMovOpFinAnual(Action<FechamentoMovOpFinAnualBuilder> configAction)
    {
    ...
    /// </summary>
    /// <returns>Instância configurada de EvtFechamentoeFinanceiraAltMessage</returns>
    public EvtFechamentoeFinanceiraAltMessage Build()
    {
        ValidateRequiredFields();
        return new EvtFechamentoeFinanceiraAltMessage(_evento, _version);
    }
...
public sealed class FechamentoMovOpFinBuilder
{
    ...
    public FechamentoMovOpFinBuilder AdicionarFechamentoMes(Action<FechamentoMovOpFinMensalBuilder> configAction)
    {
        ...
        {
            fechamentos.AddRange(_fechamento.FechamentoMes);
        }
